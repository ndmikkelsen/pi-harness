...
const LEGACY_AI_FRAMEWORKS_V1: CleanupManifest = {
  ...
  entries: [
    ...
    {
      id: 'legacy-helper-scout',
      path: '.pi/agents/scout.md',
      kind: 'file',
      disposition: 'safe-delete',
      reason: 'stale helper subagent renamed to `.pi/agents/code-scout.md`',
    },
    {
      id: 'legacy-helper-planner',
      path: '.pi/agents/planner.md',
      kind: 'file',
      disposition: 'safe-delete',
      reason: 'stale helper subagent renamed to `.pi/agents/task-planner.md`',
    },
    {
      id: 'legacy-helper-worker',
      path: '.pi/agents/worker.md',
      kind: 'file',
      disposition: 'safe-delete',
      reason: 'stale helper subagent renamed to `.pi/agents/implementer.md`',
    },
    {
      id: 'legacy-helper-researcher',
      path: '.pi/agents/researcher.md',
      kind: 'file',
      disposition: 'safe-delete',
      reason: 'stale helper subagent renamed to `.pi/agents/web-researcher.md`',
    },
    {
      id: 'legacy-helper-context-builder',
      path: '.pi/agents/context-builder.md',
      kind: 'file',
      disposition: 'safe-delete',
      reason: 'stale helper subagent renamed to `.pi/agents/context-mapper.md`',
    },
    {
