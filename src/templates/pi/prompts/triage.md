...
5. If the issue is too large, break it into linked Beads items instead of tracking work in markdown TODOs.

## Output
Return the chosen issue, why it is the right next task, acceptance criteria, and any follow-up context needed before implementation starts.
