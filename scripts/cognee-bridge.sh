...
COGNEE_BRIEF_DATASETS="${COGNEE_BRIEF_DATASETS:-pi-harness-knowledge,pi-harness-patterns,pi-harness-behavior,pi-harness-implementation,pi-harness-regressions}"
T_HEALTH=5
T_SEARCH=30
T_UPLOAD=60
T_COGNIFY=120
